...
## Глава 11. Исходный код и принципы открытости

### Статья 62. Исходный и исполняемый код
1. Исходный код – это набор инструкций и описаний на любом языке программирования в форме, читаемой человеком, который предназначен для преобразования в исполняемый код.
2. Исполняемый код – это форма программного кода, полученная в результате компиляции или интерпретации исходного кода и предназначенная для непосредственного выполнения цифровым устройством.
3. Исходный код является первоосновой любой цифровой системы и ключевым объектом для проведения аудита ее надежности, безопасности и соответствия заявленным функциям.

### Статья 63. Правовой статус исходного кода
1. Исходный код признается объектом интеллектуальной собственности, и его правовой режим определяется лицензионным соглашением, установленным правообладателем.
2. Открытым исходным кодом признается код, распространяемый на условиях открытой лицензии. Открытая лицензия предоставляет неограниченному кругу лиц право на использование, изучение, изменение и распространение кода в целях стимулирования инноваций, обеспечения технологической независимости и повышения доверия.

### Статья 64. Требования к открытости исходного кода государственных систем
1. Исходный код цифровых систем, платформ и сервисов, созданных или модернизированных за счет средств государственного бюджета, по умолчанию должен быть опубликован под открытой лицензией.
2. Публикация исходного кода обеспечивает возможность проведения независимого аудита, выявления уязвимостей исследователями информационных систем и способствует общественному контролю за деятельностью государственных органов.
3. Обязательство по публикации не распространяется на:
    1) части кода, содержащие государственные секреты, криптографические ключи, учетные данные или иную охраняемую законом тайну;
    2) код, относящийся к системам обеспечения национальной безопасности и обороны;
    3) код, раскрытие которого, по заключению уполномоченного органа, создает прямую и существенную угрозу кибербезопасности критически важных цифровых объектов.
4. Порядок и условия публикации исходного кода, а также критерии для применения исключений, определяются уполномоченным органом в сфере цифровизации по согласованию с Комитетом национальной безопасности.

### Статья 65. Депонирование исходного кода
1. В случаях, когда полная публикация исходного кода невозможна, владелец критически важного цифрового объекта или государственной цифровой системы обязан обеспечить его депонирование (передачу на хранение) у доверенной третьей стороны, аккредитованной государством.
2. Депонированный исходный код предоставляется уполномоченным государственным органам для проведения аудита, расследования инцидентов кибербезопасности или в иных случаях, прямо предусмотренных законами Республики Казахстан. Это гарантирует государственный контроль даже над закрытыми системами.
