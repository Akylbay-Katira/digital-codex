...
Публичная разработка кодекса. Все изменения проходят через Pull Request и утверждаются руководителем проекта.
  ...
  - Крупные изменения: сначала создайте issue с описанием проблемы и предложением решения (шаблон issue "Предложение изменений").
  - Оформление:
    - Чёткие заголовки, нумерованные пункты, ссылки на источники (по возможности)
    - Каждое изменение должно сопровождаться кратким описанием в PR: что меняем и почему.
